...
<div class="layui-form content">
	<div class="layui-form-item">
		...
		<div class="layui-input-inline" style="width:300px;">
		  <input type="text" name="title" lay-verify="required" value="<?php echo e($notice['title']); ?>" autocomplete="off" placeholder="请输入标题" class="layui-input" maxlength=20>
		</div>
	</div>
	<div class="layui-form-item">
		<label class="layui-form-label">排序</label>
		<div class="layui-input-inline" style="width:300px;">
		  <input type="text" name="sort" value="<?php echo e($notice['sort']); ?>" lay-verify="required" autocomplete="off" placeholder="请输入排序" class="layui-input">
		</div>
	</div>
    <script id="editor" type="text/plain" style="height:500px;"><?php echo html_entity_decode($content); ?></script>
