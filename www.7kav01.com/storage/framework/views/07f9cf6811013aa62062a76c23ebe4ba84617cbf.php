...
<div class="course-box bg-w">
	<fieldset class="layui-elem-field layui-field-title">
		<legend><?php if(!empty($_GET['key'])): ?>搜索<?php elseif(!empty($_GET['type'])): ?><?php echo e(Cachekey('type')[$_GET['type']]); ?><?php elseif(!empty($_GET['tag'])): ?>标签<?php else: ?>视频<?php endif; ?>列表>></legend>
	</fieldset>
