	...
	<div class="layui-layout layui-layout-admin">
			...
			<div class="layui-main">
			    ...
			    <ul class="layui-nav top_menu">
					...
					<li class="layui-nav-item" pc>
						<a href="javascript:;">
							<img src="<?php echo e(asset('images/header.jpg')); ?>" class="layui-circle" width="35" height="35">
							<cite><?php echo e(config('deploy.amdin_meb_ident')[$ident]); ?></cite>
						</a>
						<dl class="layui-nav-child">
							<dd><a href="javascript:;" data-url="<?php echo e(url('manage/changepword')); ?>"><i class="fa fa-expeditedssl" data-icon="fa-expeditedssl"></i><cite>修改密码</cite></a></dd>
							<dd><a href="<?php echo e(url('manage/logout')); ?>"><i class="fa fa-sign-out"></i><cite>退出</cite></a></dd>
						</dl>
					</li>
				</ul>
			</div>
		...
		<div class="layui-side layui-bg-black" id="admin-side">
			<div class="user-photo">
				<a class="img" title="我的头像" ><img src="<?php echo e(asset('images/header.jpg')); ?>"></a>
				<p>你好！<span class="userName"><?php echo e(config('deploy.amdin_meb_ident')[$ident]); ?></span>, 欢迎登录</p>
			</div>
