<footer>
	<a <?php if($as == 'index'): ?> class="active" href="javascript:;" <?php else: ?> href="../m/index" <?php endif; ?>>
	...
	<a <?php if($as == 'free'): ?> class="active" href="javascript:;" <?php else: ?> href="../m/free" <?php endif; ?>>
		<i class="layui-icon layui-icon-flag"></i>
		<span class="text-omit" >必看说明</span>
	</a>
	<a <?php if($as == 'ucenter'): ?> class="active" href="javascript:;" <?php else: ?> href="../m/ucenter" <?php endif; ?>>
