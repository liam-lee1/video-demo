...
function() {
    ...
    function(e, t, n) {
        ...
        var a = function() {
            ...
            },
            {
                key: "update",
                value: function() {
                    this.template.infoVersion.innerHTML = "v1.23.0 c3dc104",
        ...
        var a = function() {
            function e(t) {
                ...
                [].concat(function(e) {
                    ...
                    return Array.from(e)
                } (this.player.template.menuItem)).map(function(e, t) {
                    return n.player.options.contextmenu[t].click && e.addEventListener("click",
                    function() {
        ...
        var r = function() {
            function e(t) {
                ...
                if (this.player.danmaku) {
                    ...
                    var o = function(e) {
                        var t = e || window.event,
                        i = ((t.clientX || t.changedTouches[0].clientX) - s.
                    default.getElementViewLeft(n.player.template.danmakuOpacityBarWrap)) / 130;
                        i = Math.max(i, 0),
                        i = Math.min(i, 1),
        ...
        var l = function() {
            ...
            },
            {
                ...
                value: function() {
                    ...
                    default.getElementViewLeft(e.player.template.playedBarWrap)) / e.player.template.playedBarWrap.clientWidth;
                        n = Math.max(n, 0),
                        n = Math.min(n, 1),
            ...
            },
            {
                ...
                value: function() {
                    ...
                    default.getElementViewLeft(e.player.template.volumeBarWrap) - 5.5) / 35;
                        e.player.volume(i)
                    },
                    n = function n() {
                        document.removeEventListener(a.
                ...
                default.nameMap.dragStart,
                    ...
                    function() {
                        e.player.video.muted ? (e.player.video.muted = !1, e.player.switchVolumeIcon(), e.player.bar.set("volume", e.player.volume(), "width")) : (e.player.video.muted = !0, e.player.template.volumeIcon.innerHTML = s.
    ...
    function(e, t, n) {
        ...
        var r = function() {
            function e(t) {
                ...
                var i = function() {
                    n.player.resize(),
                    n.isFullScreen("browser") ? n.player.events.trigger("fullscreen") : (s.
                default.setScrollPosition(n.lastScrollPosition), n.player.events.trigger("fullscreen_cancel"))
                };
                this.player.container.addEventListener("fullscreenchange", i),
                this.player.container.addEventListener("mozfullscreenchange", i),
            ...
            },
            {
                ...
                value: function() {
                    ...
                    switch (n || (this.lastScrollPosition = s.
        ...
        var o = function() {
            ...
            },
            {
                ...
                value: function(e, t) {
                    ...
                    i = [], a = 0, o = function(o) {
                        return function(s, r) {
                            if (++a, s) s.response ? n.options.error(s.response.msg) : n.options.error("Request was unsuccessful: " + s.status),
                            i[o] = [];
                            else {
                    ...
                    s = 0; s < e.length; ++s) this.options.apiBackend.read(e[s], o(s))
                }
            },
            {
                key: "send",
            ...
            },
            {
                ...
                value: function(e) {
                    ...
                    if (this.showing) {
                        ...
                        c = function(e, n, o) {
                            for (var c = a / l(o), u = function(i) {
                                var o = t.danTunnel[n][i + ""];
                                if (!o || !o.length) return t.danTunnel[n][i + ""] = [e],
                                e.addEventListener("animationend",
                                function() {
                                    t.danTunnel[n][i + ""].splice(0, 1)
                                }),
                                {
                                    v: i % s
                                };
                                ...
                                for (var u = 0; u < o.length; u++) {
                                    var d = r(o[u]) - 10;
                                    if (d <= a - c * l(parseInt(o[u].style.width)) || d <= 0) break;
                                    if (u === o.length - 1) return t.danTunnel[n][i + ""].push(e),
                                    e.addEventListener("animationend",
                                    function() {
                                        t.danTunnel[n][i + ""].splice(0, 1)
                                    }),
                        ...
                        for (var u = document.createDocumentFragment(), d = function(i) {
                            e[i].type || (e[i].type = "right"),
                            e[i].color || (e[i].color = "#fff");
                            var o = document.createElement("div");
                            o.classList.add("dplayer-danmaku-item"),
                            o.classList.add("dplayer-danmaku-" + e[i].type),
                            e[i].border ? o.innerHTML = '<span style="border:' + e[i].border + '">' + e[i].text + "</span>": o.innerHTML = e[i].text,
                            o.style.opacity = t._opacity,
                            o.style.color = e[i].color,
                            o.addEventListener("animationend",
                            function() {
                                t.container.removeChild(o)
                            });
                            var s = t._measure(e[i].text),
                            r = void 0;
                            switch (e[i].type) {
                            case "right":
                                (r = c(o, e[i].type, s)) >= 0 && (o.style.width = s + 1 + "px", o.style.top = n * r + "px", o.style.transform = "translateX(-" + a + "px)");
                                break;
                            case "top":
                                (r = c(o, e[i].type)) >= 0 && (o.style.top = n * r + "px");
                                break;
                            case "bottom":
                                (r = c(o, e[i].type)) >= 0 && (o.style.bottom = n * r + "px");
                                break;
                            default:
                                console.error("Can't handled danmaku type: " + e[i].type)
                            }
        ...
        "use strict"; (function(t) {
            ...
            a.$escape = function(e) {
                return function(e) {
                    ...
                    s = void 0,
                    r = void 0;
                    for (a = n.index, s = 0; a < t.length; a++) {
    ...
    function(e, t, n) {
        ...
        e.exports = function(e) {
            ...
            s.danmaku && s.danmaku.bottm && (a += ' style="margin-bottom:', a += r(s.danmaku.bottm), a += '"'),
            ...
            a += r(l("Unlimited danmaku")),
            a += '</span>\n                        <div class="dplayer-toggle">\n                            <input class="dplayer-danunlimit-setting-input" type="checkbox" name="dplayer-toggle-danunlimit">\n                            <label for="dplayer-toggle-danunlimit"></label>\n                        </div>\n                    </div>\n                    <div class="dplayer-setting-item dplayer-setting-danmaku">\n                        <span class="dplayer-label">',
            a += r(l("Opacity for danmaku")),
    ...
    function(e, t, n) {
        ...
        p = -1;
        function h() {
            d && c && (d = !1, c.length ? u = c.concat(u) : p = -1, u.length && y())
        }
        function y() {
            if (!d) {
                var e = l(h);
            ...
            function(e, n) {
                if (!e.setImmediate) {
                    ...
                    i = function(e) {
                        ...
                        setTimeout(y, 0, e)
                    }: (s = "setImmediate$" + Math.random() + "$", r = function(t) {
                        t.source === e && "string" == typeof t.data && 0 === t.data.indexOf(s) && y( + t.data.slice(s.length))
                    },
                    e.addEventListener ? e.addEventListener("message", r, !1) : e.attachEvent("onmessage", r), i = function(t) {
                        e.postMessage(s + t, "*")
                    }),
            ...
            function d(e, t) {
                try {
                    ...
                    if (t && ("object" === (void 0 === t ? "undefined": a(t)) || "function" == typeof t)) {
                        ...
                        e._value = t,
                        void h(e);
                        if ("function" == typeof n) return void y((i = n, o = t,
                        function() {
                            i.apply(o, arguments)
                        }), e)
                    }
                    ...
                    function s(e, r) {
                        try {
                            if (r && ("object" === (void 0 === r ? "undefined": a(r)) || "function" == typeof r)) {
                                var l = r.then;
                                if ("function" == typeof l) return void l.call(r,
                                function(t) {
                                    s(e, t)
                                },
                                n)
        ...
        q = function() {
            ...
            },
            {
                ...
                default.resolve(this.video.play()).
                        ...
                        e.pause()
                    }).then(function() {}), this.timer.enable("loading"), this.container.classList.remove("dplayer-paused"), this.container.classList.add("dplayer-playing"), this.danmaku && this.danmaku.play(), this.options.mutex) for (var t = 0; t < _.length; t++) this !== _[t] && _[t].pause()
                }
            },
            {
                key: "pause",
            ...
            },
            {
                ...
                value: function(e, t) {
                    ...
                    function() {
                        1 !== e.duration && (n.template.dtime.innerHTML = o.
                    ...
                    function() {
                        ...
                        n.setting.loop ? (n.seek(0), e.play()) : n.pause(),
                    ...
                    this.options.subtitle && (this.subtitle = new y.
