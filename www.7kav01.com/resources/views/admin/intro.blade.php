	...
	<div class="layui-row layui-col-space15">
		<div class="layui-col-sm6 layui-col-md3">
			<div class="layui-card">
			  ...
			  <div class="layui-card-body layuiadmin-card-list">
				<p class="layuiadmin-big-font">{{$data['all']}}</p>
				<p>
				  总计 
		...
		<div class="layui-col-sm6 layui-col-md3">
			<div class="layui-card">
			  ...
			  <div class="layui-card-body layuiadmin-card-list">
				<p class="layuiadmin-big-font">{{$data['new']}}</p>
				<p>
				  总计 
		...
		<div class="layui-col-sm6 layui-col-md3">
			<div class="layui-card">
			  ...
			  <div class="layui-card-body layuiadmin-card-list">
				<p class="layuiadmin-big-font">{{$data['episode']}}</p>
				<p>
				  专辑总计 
				  <span class="layuiadmin-span-color">{{$data['album']}}<i class="layui-inline layui-icon layui-icon-upload"></i></span>
				</p>
			  </div>
			</div>
		</div>
		<div class="layui-col-sm6 layui-col-md3">
			<div class="layui-card">
			  ...
			  <div class="layui-card-body layuiadmin-card-list">
				<p class="layuiadmin-big-font">{{$data['credit_today']}}</p>
				<p>
				  总计 
				  <span class="layuiadmin-span-color">{{$data['credit_all']}}<i class="layui-inline layui-icon layui-icon-auz"></i></span>
				</p>
			  </div>
			</div>
		</div>
...
<script type="text/javascript" src="{{ asset('js/echarts.simple.min.js') }}"></script>
