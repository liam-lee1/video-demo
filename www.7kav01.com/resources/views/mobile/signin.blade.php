	...
	<div class="layui-form">
		...
		<div class="account-form-group">
			<div class="layui-input-inline full">
			  <input type="text" name="user" lay-verify="required" value="@if(!empty(Cookie::get('user'))){{Cookie::get('user')}}@endif" autocomplete="off" maxlength="11" placeholder="账号" class="layui-input">
			</div>
		</div>
		<div class="account-form-group">
			<div class="layui-input-inline full">
